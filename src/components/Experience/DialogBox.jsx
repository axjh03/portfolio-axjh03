...
const DialogBox = forwardRef(({ title, name, details, onClose }, ref) => {
  return (
    <dialog 
      ref={ref} 
      className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 border rounded-md w-150 bg-white"
    >
      ...
      <form method="dialog" className="mt-1 flex justify-center">
        <button 
          onClick={onClose} 
